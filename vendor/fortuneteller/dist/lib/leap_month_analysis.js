 ...
 * 윤달 출생자 종합 분석
 */
export function analyzeLeapMonthBirth(sajuData) {
 ...
 * 윤달 출생자 특성
 */
function getLeapMonthCharacteristics(sajuData) {
 ...
 */
function calculateLeapMonthElementAdjustments(sajuData) {
    const adjustments = [];
 ...
 * 윤달 출생자 인생 해석
 */
function getLeapMonthLifePath(sajuData) {
    const monthElement = sajuData.month.branchElement;
 ...
 * 윤달 출생자 권장사항
 */
function getLeapMonthRecommendations(sajuData) {
 ...
 * 윤달 출생자 주의사항
 */
function getLeapMonthWarnings(sajuData) {
    const warnings = [];
 ...
 */
export function applyLeapMonthJiJangGanAdjustment(_branch, isLeapMonth, originalStrength) {
    if (!isLeapMonth) {
